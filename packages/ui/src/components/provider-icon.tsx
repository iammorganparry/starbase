...
/**
 * Brand marks for the coding-agent providers (monochrome, `currentColor` so they
 * inherit the surrounding text colour). Paths are the official 24×24 logos —
 * Anthropic for Claude, OpenAI for Codex, Cursor for Cursor Agent.
 */
