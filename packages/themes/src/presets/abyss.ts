...
export const abyss: VsCodeTheme = {
  ...
  "colors": {
    ...
    "agentsChatInput.border": "#2b2b4a",
    "agentsChatInput.focusBorder": "#596F99",
    "agentsNewSessionButton.border": "#2b2b4a",
