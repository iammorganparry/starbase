/**
 * Tomorrow Night Blue — vendored from microsoft/vscode (MIT), ref `main`.
 *
...
export const tomorrowNightBlue: VsCodeTheme = {
  ...
  "colors": {
    "focusBorder": "#bbdaff",
    "agentsPanel.border": "#404f7d",
    "agentsChatInput.border": "#404f7d",
    "agentsChatInput.focusBorder": "#bbdaff",
    "agentsNewSessionButton.border": "#404f7d",
